...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh1->LoadMesh("C:/GE/Projects/Content-main/phoenix_ugv.md2")) {
            return false;            
        }
        
        m_pMesh2 = new Mesh();

        if (!m_pMesh2->LoadMesh("C:/GE/Projects/Content-main/jeep.obj")) {
            return false;            
        }

        m_pMesh3 = new Mesh();

        if (!m_pMesh3->LoadMesh("C:/GE/Projects/Content-main/hheli.obj")) {
            return false;            
        }
